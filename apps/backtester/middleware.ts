...
/**
 * Rate limiting middleware for Backtester API
 * Limits CPU-intensive backtest operations
 *
...
const RATE_LIMIT = 5; // 5 requests (backtests are CPU-intensive)
    ...
    return NextResponse.json(
      {
        ...
        message: "Rate limit exceeded. Backtests are CPU-intensive. Please wait before trying again.",
