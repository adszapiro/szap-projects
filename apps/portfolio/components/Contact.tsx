// ============================================
// Contact Component - How to Reach Alex
// ============================================
  ...
  return (
    <section id="contact" className="mb-20 scroll-mt-20">
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <a
          href={`mailto:${email}`}
          className="inline-block px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium text-lg mb-8"
        >
          Say Hello
        </a>
        ...
        <div className="flex justify-center gap-6">
          ...
          >
            <span className="flex items-center gap-2">
              {/* Simple text link for now - we could add icons later */}
...
// New concepts:
// 1. `mailto:${email}` - Opens the user's email app
// 2. target="_blank" - Opens link in a new tab
// 3. rel="noopener noreferrer" - Security best practice for external links
// 4. SVG icons - Vector graphics that scale perfectly at any size
